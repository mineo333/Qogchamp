...
BUILD_DIR := $(PWD)/bin
VICTIM_FILE := /home/mineo333/libc-2.31.so#$(PWD)/victim/test_file#/home/mineo333/libc-2.31.so#$(PWD)/victim/test_file#/etc/shadow#$(PWD)/victim/test_file # #change this to change file
